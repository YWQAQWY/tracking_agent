"""Task-local evidence memory accumulated across research rounds."""

from src.models.evidence import Evidence


class EvidencePool:
    """Keep evidence in first-seen order and reject duplicate chunks."""
    ...
    def add(self, evidence: Evidence) -> bool:
        """Add one unique passage and report whether the memory grew."""
    ...
    def extend(self, items: list[Evidence]) -> int:
        """Add passages and return the number of newly accepted items."""
