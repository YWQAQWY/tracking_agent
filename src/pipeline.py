"""Readable V0.2 Search -> Fetch -> Extract -> Read pipeline."""
...
class TrackerPipeline:
    ...
    async def run(self, question: str) -> PipelineResult:
        ...
        logger.info("Search query: %s", plan.query)

        search_results = self.search_provider.search(plan.query, plan.max_results)
